...
const tr = {
    ...
    'root.secondaryTab': 'Uyarı: Uygulama başka bir sekmede açık — değişiklikler bu sekmede kaydedilmez.',
    ...
    'settings.integrityIssue': 'Uyarı: Dosya bütünlüğü: {{result}}',
    'settings.noOrphanCards': '✓ Sahipsiz kart yok',
    'settings.orphanCards': 'Uyarı: {{count}} sahipsiz kart bulundu',
    'settings.noOrphanNotes': '✓ Kartsız not yok',
    'settings.orphanNotes': 'Uyarı: {{count}} kartsız not bulundu',
...
const en: Record<TranslationKey, string> = {
    ...
    'root.secondaryTab': 'Warning: The app is open in another tab — changes in this tab will not be saved.',
    ...
    'settings.integrityIssue': 'Warning: File integrity: {{result}}',
    'settings.noOrphanCards': '✓ No orphaned cards',
    'settings.orphanCards': 'Warning: Found {{count}} orphaned cards',
    'settings.noOrphanNotes': '✓ No notes without cards',
    'settings.orphanNotes': 'Warning: Found {{count}} notes without cards',
