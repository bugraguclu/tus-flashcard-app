# App Store Connect teslim metni — Türkçe

## Uygulama kaydı

- Ad: `TusAnkiM`
- Alt başlık: `TUS için akıllı tekrar`
- Bundle ID: `com.tusankim.app`
- Sürüm: `1.0.0`
- Build: `1` (EAS üretimde otomatik artırır)
- Ana kategori: `Education`
- İkincil kategori: boş bırakılması önerilir
- Uygulama fiyatı: `Ücretsiz`
- Hedef cihaz: `Yalnızca iPhone`
- Gizlilik: `https://bugraguclu.github.io/tus-flashcard-app/privacy.html`
- Destek: `https://bugraguclu.github.io/tus-flashcard-app/support.html`
- Koşullar: `https://bugraguclu.github.io/tus-flashcard-app/terms.html`

> Yayın notu: Bu üç taslak URL 21 Ağustos 2026 kontrolünde 404 döndürmektedir. İlgili yerel HTML dosyaları yayımlanıp adresler HTTP 200 vermeden App Store Connect’e girilmemelidir.
...
## Anahtar kelimeler (100 bayt altında)

`TUS,flashcard,tıp,uzmanlık,sınav,aralıklı tekrar,kart,öğrenme,deste,ezber`

## Telif

`2026 [APP STORE CONNECT HESAP SAHİBİNİN YASAL ADI]`

Yayıncı adı, gerçek destek e-postası/telefonu ve yasal adres App Store Connect’e girilmeden gönderim yapılmamalıdır.

## Ekran görüntüsü sırası ve başlıkları
...
- Medical or Treatment Information: `Frequent` (kartlarda tedavi/ilaç bilgisi bulunabilir)
- Unrestricted Web Access: `No` (bağlantılar sistem tarayıcısında açılır; uygulama bir web tarayıcısı değildir)
- User-Generated Content: `No` (kartlar cihazda özeldir, toplulukta yayımlanmaz)
- Diğer şiddet/cinsellik/kumar/sosyal özellikler: gerçek içerik taramasıyla yanıtlanmalı
- Beklenen küresel derecelendirme: `16+`
- Regulated Medical Device: `No`
- Kullanım beyanı: `TUS sınavına hazırlık için eğitim uygulamasıdır; tanı, tedavi veya klinik karar desteği sağlamaz.`
