...
| Filtered decks and custom study | Implemented subset | Context-preserving overview panels, two independent filters, gather limit/order stored with Anki's own ordinals (migration 10), rescheduling/preview, excluded-card reporting, in-app help, deck manager and study repository tests | Expand search grammar and FSRS scheduling before full parity claim |
