...
| Hierarchical decks and presets | Implemented | validated/atomic Deck Options save flow, local parent/subdeck scope picker, explicit per-deck preset separation, deck manager, deck-options scope/form, and deck-navigation tests | Continue parent/subdeck limit tests |
